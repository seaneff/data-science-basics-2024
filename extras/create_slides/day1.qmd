...
![](images/childhood_graphic.png){fig-align="center"}

![](images/steph_rosie.png){fig-align="center"}
...
is(3.14)
is(TRUE)
is("International Health Regulations (IHR)")
```
...
- General naming requirements: 
  - a variable name can’t start with a number or a dot (.)
...
- We won't go into the details in this workshop, but you can learn more [here](https://r4ds.had.co.nz/vectors.html) if you run into this type of error message

## Functions

::: {.incremental}
  - Functions are instructions to perform a task
  - They are algorithms, or consistent sets of rules
  - R has built-in functions for many basic things
  - Functions generally look like this: `function(object)`
  - We can also “add on” extra functions by loading new libraries (we’ll get to this later), or we can write our own functions
...
- Use `?function-name` or `help(function-name)` to learn more about functions
...
- Backups are useful to save progress, understand what we’ve done before, look into problems/bugs, and share our work in progress
...
<center>
We’ll talk more about github later in this workshop. For now, I’d like you to be able to use it to access course materials.
<br><br><br>
<https://github.com/seaneff/data-science-basics-2024>
</center>
...
_Please come with a fully charged laptop._
</center>
